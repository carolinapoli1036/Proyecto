  ...
  return (
    <div style={{ background: '#EDEDE9', minHeight: '100vh', flex: 1, fontFamily: sans, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ background: '#1a1a1a', padding: '100px 48px 120px', position: 'relative', overflow: 'hidden', flex: 1 }}>
        ...
        <div style={{ maxWidth: '680px', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.06)', border: '0.5px solid rgba(255,255,255,0.1)', borderRadius: '20px', padding: '6px 16px', marginBottom: '40px' }}>
            ...
            <span style={{ fontSize: '11px', color: '#9E9890', letterSpacing: '1.5px', textTransform: 'uppercase' as const, fontFamily: sans }}>Carpooling universitario · Medellín</span>
          </div>
          ...
          <p style={{ fontSize: '16px', color: '#6b6b6b', lineHeight: 1.7, marginBottom: '48px', maxWidth: '480px', fontFamily: sans, fontWeight: 300 }}>
            Conectamos estudiantes universitarios de Medellín para compartir rutas, reducir costos y llegar juntos a la U.
          </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 200px)', gap: '1px', background: 'rgba(255,255,255,0.06)', borderRadius: '14px', overflow: 'hidden', marginTop: '80px', width: 'fit-content' }}>
          {[
            ...
            { value: '3', label: 'Universidades conectadas' },
      ...
      <div style={{ background: '#EDEDE9', padding: '80px 48px' }}>
        <p style={{ fontSize: '11px', color: '#9E9890', letterSpacing: '2px', textTransform: 'uppercase' as const, marginBottom: '48px', fontFamily: sans }}>Cómo funciona</p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
          {[
            { num: '01', title: 'Regístrate', desc: 'Crea tu cuenta con tu correo universitario y selecciona tu perfil: conductor o pasajero.' },
            { num: '02', title: 'Encuentra tu ruta', desc: 'Busca rutas disponibles desde tu estación de metro o comuna hacia tu universidad.' },
            { num: '03', title: 'Viaja y gana puntos', desc: 'Completa viajes y acumula puntos. Cada viaje compartido suma a tu historial.' },
          ].map((f, i) => (
      ...
      <div style={{ background: '#1a1a1a', padding: '80px 48px', textAlign: 'center' as const }}>
        ...
        <p style={{ fontSize: '14px', color: '#6b6b6b', marginBottom: '40px', fontFamily: sans, fontWeight: 300 }}>Únete a la comunidad de carpooling universitario de Medellín.</p>
