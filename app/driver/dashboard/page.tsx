export default function DriverDashboard() {
  return (
    <div className="min-h-screen bg-base-200">
      ...
      {/* Navbar */}
      <div className="navbar bg-secondary text-secondary-content px-6">
        <h1 className="text-xl font-bold">🚗 CarPooling - Conductor</h1>
      ...
      <div className="p-8">
        <h2 className="text-2xl font-bold mb-6">Bienvenido, Juan Pérez 👋</h2>

        {/* Tarjetas resumen */}
        <div className="grid grid-cols-4 gap-6 mb-8">
          <div className="card bg-base-100 shadow">
            <div className="card-body">
              <h3 className="text-lg font-semibold">🗺️ Mis Rutas</h3>
              <p className="text-4xl font-bold text-secondary">3</p>
            </div>
          </div>
          <div className="card bg-base-100 shadow">
            <div className="card-body">
              <h3 className="text-lg font-semibold">👥 Pasajeros Hoy</h3>
              <p className="text-4xl font-bold text-primary">5</p>
            </div>
          </div>
          <div className="card bg-base-100 shadow">
            <div className="card-body">
              <h3 className="text-lg font-semibold">🚘 Mi Vehículo</h3>
              <p className="text-2xl font-bold text-accent">ABC-123</p>
            </div>
          </div>
          {/* Tarjeta de puntos */}
          <div className="card bg-base-100 shadow border-2 border-warning">
            <div className="card-body">
              ...
              <p className="text-4xl font-bold text-warning">320</p>
              <p className="text-xs opacity-60">Nivel: Colaborador</p>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-100 shadow mb-8">
          <div className="card-body">
            <h3 className="text-xl font-bold mb-4">➕ Publicar Nueva Ruta</h3>
            <div className="flex gap-4">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Puestos</span>
                </label>
                <input type="number" min="1" max="4" placeholder="1-4" className="input input-bordered w-20" />
              </div>
        ...
        <div className="card bg-base-100 shadow">
          <div className="card-body">
            <h3 className="text-xl font-bold mb-4">📅 Viajes de Hoy</h3>
